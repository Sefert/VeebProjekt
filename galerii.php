...
?>
<div>
    <div id="left" class="mid" <?php echo $width_right_side_style?>>
        <img src="<?php echo $directory."/".$files[$i+2]?>" onclick="add(<?php echo $i ?>)">
        <div style="max-height:250px; overflow: hidden;"><img class="mirror" src="<?php echo $directory."/".$files[$i+2]?>"></div>
    </div>
    ...
    <div id="right" class="mid" <?php echo $width_left_side_style?> >
        <img src="<?php echo $directory."/".$files[$i]?>" onclick="subtract(<?php echo $i ?>)">
        <div style="max-height:250px; overflow: hidden;"><img class="mirror" src="<?php echo $directory."/".$files[$i]?>"></div>
    </div>
</div>
